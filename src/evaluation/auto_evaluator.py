...
This module provides the AutoEvaluator class for automated evaluation of the
stock trading platform agent. It runs test cases against the LangGraph workflow,
uses LLM-as-a-Judge for scoring, extracts agent and tool usage from traces,
...
class AutoEvaluator:
    ...
    def evaluate_answer(
        ...
        Args:
            ...
            actual_answer: Actual answer text
            
        Returns:
            Dictionary with relevance and accuracy scores
        """
    ...
    def extract_agent_from_messages(self, messages: List[Any]) -> str:
        ...
        Returns:
            Agent name or 'supervisor' as default
        """
    ...
    def extract_tools_from_trace(self, trace_id: str) -> List[str]:
        ...
        Returns:
            List of tool names used in the trace
        """
        try:
            ...
            logger.warning(f"Could not extract tools from trace (data structure error): {e}")
            return []
        except Exception as e:
            logger.warning(f"Could not extract tools from trace (API/network error): {e}")
            return []
    ...
    async def evaluate_single_test(
        ...
        Args:
            test_case: Test case dictionary with question, expected_answer, etc.
        ...
        try:
            ...
            try:
                ...
                logger.warning(f"Failed to add scores (invalid data): {e}")
            except Exception as e:
                logger.warning(f"Failed to add scores (API/network error): {e}")
    ...
    async def run_evaluation(
        ...
        Returns:
            MetricsTracker with aggregated results
        """
