...
This module provides the DocumentExtractor class for extracting text from
documents (primarily PDFs) and chunking them for vector storage. It supports:
- PDF text extraction
- Recursive text chunking
- FAQ Q&A pair extraction (with optional GPT-4o vision support)
